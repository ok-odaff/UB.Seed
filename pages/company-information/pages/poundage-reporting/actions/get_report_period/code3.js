...
tableLabels.push(`${period2begin.toLocaleDateString('en-US', {
  ...
  {{state.report_periods}}.push(`${period2begin.toLocaleString('en-US', {month: 'short', 
                                                                         year: '2-digit'
  ...
  {{state.report_periods}}.push(`${period1begin.toLocaleString('en_US', {month: 'short', year: '2-digit'})} - ${period1end.toLocaleString('en_US', {month: 'short', year: '2-digit'})}`);
}
